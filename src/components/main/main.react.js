            ...
            <div>
                <main className="container">
                    ...
                    <div className="main_cards">
                        ...
                        <Goods image="../../img/content/Base2.jpg" oldprice="$32" newprice="$12" goodName="Jogging bermuda shorts"/>
                        ...
                        <Goods image="../../img/content/Base8.jpg" oldprice="$32" newprice="$12" goodName="T-shirt with lower panel"/>*/}
                        <GoodsDetail/>
                    </div>
                </main>
            </div>
